...
leaflet(map_data) %>% 
      ...
      addCircleMarkers(lat= ~latitude
                       ...
                       , popup= paste0(map_data$name_simp,", ", 
                                       ...
                                       ": ", map_data$pct_bachelors)
                       , stroke = FALSE 
                       , radius = 7
                       , fillColor = mypal(map_data$pct_bachelors)
                       , fillOpacity = 1.0) %>%
      
      addLegend(pal = mypal, 
                values = map_data$pct_bachelors, 
                position = "bottomleft", 
                title = paste0("Percent of Population", "<br>", "with a Bachelor's Degree", "<br>", "(2018)"),
                opacity = 1.0)
